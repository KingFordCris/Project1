        ...
        <form class="container" method="POST" action="/user/profile/save">
            ...
            {{ csrf_field() }} 
                ...
                <div class="form-row" id="basicInfo">
                    ...
                    <option value="{{$course->courseAbbr}}">{{$course->courseName}}</option>
                    @endforeach
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="status" id="status" class="form-control{{ $errors->has('status') ? ' has-error' : '' }}"  required>
                            ...
                            <option value="widow">Separated</option>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control{{ $errors->has('contactNum') ? ' has-error' : '' }}" id="contactNum" name="contactNum" value="{{ old('contactNum') }}" placeholder="09123.." required>
            ...
            <p style="float: right;" >
                    <button class="btn btn-primary btn-round" type="submit" onclick="return confirm('Are you sure you want to submit this application profile?'); "> <i class="material-icons">done</i>Add</button>
