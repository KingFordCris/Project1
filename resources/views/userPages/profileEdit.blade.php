    ...
    <div>  <br>
        ...
        <form class="container" method="POST" action="{{ route('OSMS_scholars.update',$scholar->id) }}">
            ...
            <p style="float: right;color:white" >
                    ...
                    <button class="btn btn-primary btn-round pull-right" type="submit" onclick="return confirm('Are you sure you want save changes?'); "><i class="material-icons">done</i>Update</button> 
                    <a href="/user/index" class="btn btn-danger btn-round pull-right" onclick="return confirm('Discard Changes?'); "><i class="material-icons">clear</i>Back</a>          
            </p>
        </div>
    </form>
@endsection
